...
P13 materializa causa raíz, acciones correctivas, evidencia de ejecución, alertas y revisión independiente de eficacia. Superó las verificaciones locales, pero no hereda aprobación automática: G13 requiere CI sobre PostgreSQL 17 y aceptación formal del titular.
