...
P04–P10 están aprobadas internamente. P11 materializa fichas KPI versionadas, fórmulas declarativas, observaciones, cálculo reproducible y publicación corregible; superó las verificaciones locales y el CI #48 sobre PostgreSQL 17, pero no hereda aprobación automática. G11 requiere todavía la aceptación formal del titular.
